...
const DashboardChatInterface: React.FC<DashboardChatInterfaceProps> = ({ mode, onModeChange }) => {
  ...
  return (
    <>
      ...
      {/* MAIN CONTAINER - WHITE BACKGROUND LIKE HOMEPAGE */}
      <div className={`flex flex-col h-full rounded-xl shadow-xl transition-all duration-300 bg-white border border-gray-200 ${
        isFocused ? 'fixed inset-4 z-50 shadow-2xl' : ''
      }`}>
        
        {/* HEADER - WHITE BACKGROUND WITH BLACK TEXT */}
        <div className="bg-white text-black p-4 rounded-t-xl border-b border-gray-200">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              {config.icon}
              <h2 className="text-lg font-semibold">{config.title} - DASHBOARD VERSION</h2>
            </div>
            <div className="flex items-center space-x-2">
              {onModeChange && (
                <select
                  ...
                  className="bg-gray-100 border border-gray-300 rounded px-2 py-1 text-sm text-black"
                >
              ...
              <button
                onClick={clearChat}
                className="bg-gray-200 hover:bg-gray-300 px-3 py-1 rounded text-sm transition-colors border border-gray-300 text-black"
              >
                Clear
              </button>
              {isFocused && (
              ...
              {!isFocused && (
                <button
                  ...
                  className="bg-gray-200 hover:bg-gray-300 p-2 rounded-lg transition-colors text-black"
        ...
        <div className="p-4 border-t border-gray-200 bg-white">
          ...
          <div className="flex space-x-2">
            ...
            <button
              ...
              className="bg-gray-800 hover:bg-gray-700 disabled:bg-gray-400 text-white p-2 rounded-lg transition-colors border border-gray-600"
            >
          ...
          <div className="flex items-center justify-start space-x-2 mt-4 pt-4 border-t border-gray-200">
            <button
              className="p-2 bg-gray-600 hover:bg-gray-500 text-white rounded-lg transition-colors border border-gray-600"
              title="Regenerate"
            >
            ...
            <button
              ...
              className="p-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors shadow-lg border border-gray-600"
            ...
            <button
              ...
              className="p-3 bg-green-600 hover:bg-green-700 text-white rounded-lg transition-colors shadow-lg border border-gray-600"
          ...
          {mode === 'seo-content' && (
            <div className="mt-2 flex flex-wrap gap-1">
              <button
                ...
                className="text-xs bg-gray-600 hover:bg-gray-500 px-2 py-1 rounded transition-colors text-white border border-gray-600"
              >
                SEO Blog Template
              </button>
              <button
